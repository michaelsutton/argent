...
if [ "$regen_examples" = true ]; then
    ...
    cargo run -- build examples/route_state_bodies.ag --out examples/build/route_state_bodies
    cargo run -- build examples/route_state_body_choice.ag --out examples/build/route_state_body_choice
